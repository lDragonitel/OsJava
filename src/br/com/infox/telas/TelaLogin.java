...
public class TelaLogin extends javax.swing.JFrame {
    ...
    public void logar() {
        ...
        try {
            ...
            if (rs.next()) {
                //a linha abaixo obtém o conteudo da tabela perfil
                String perfil = rs.getString(6);
                //System.out.println(perfil);//sout Ctrl+Espaço
    ...
    public TelaLogin() {
        ...
        //a linha abaixo server de apoio ao status de conexão
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(317, 187));
